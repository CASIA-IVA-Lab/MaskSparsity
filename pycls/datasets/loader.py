...
from pycls.datasets.place365 import Place365
from pycls.datasets.place290 import Place290
...
# Supported datasets
_DATASETS = {"cifar10": Cifar10, "imagenet": ImageNet, "place365": Place365 , "place290":Place290}

# Default data directory (/path/pycls/pycls/datasets/data)
_DATA_DIR = os.path.join(os.path.dirname(__file__), "data")

# Relative data paths to default data directory
_PATHS = {"cifar10": "cifar10", "imagenet": "imagenet", "place365" :"places365_standard", "place290" :"places290_jnf"}
